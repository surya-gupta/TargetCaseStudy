...
public class Utility {
    ...
    public  static String getMinutes(String dateString) {
        LocalDateTime now = LocalDateTime.now();
        LocalDateTime nextTravelTime = LocalDateTime.ofInstant(Instant.ofEpochMilli(Long.valueOf(dateString.substring(6, 19))),
